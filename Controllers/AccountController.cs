...
using TrainingApp.Models.AccountViewModels;
...
namespace TrainingApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private async Task<Guid> CreateCrmContact(ApplicationUser user)
        {
            ...
            return  _orgService.Create(contact);
           
        }

        //private async Task CreateCrmContact()
        //{
